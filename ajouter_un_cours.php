...
<form id="form_ajout_cours" method="POST" action="" style="max-width: 600px; display: flex; flex-direction: column; gap: 1rem; background: var(--white); padding: 2rem; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
    ...
    <button type="submit" id="btn_submit" style="padding: 0.8rem; background: var(--primary-color); color: white; border: none; cursor: pointer; border-radius: 4px; font-weight: bold; font-size: 1rem; margin-top: 1rem;">Enregistrer le contenu</button>
</form>
...
<script>
document.getElementById('form_ajout_cours').addEventListener('submit', async function(e) {
    e.preventDefault();
    ...
    if (fileInput.files.length > 0) {
        ...
        try {
            ...
            submitBtn.innerText = 'Enregistrer le contenu';
